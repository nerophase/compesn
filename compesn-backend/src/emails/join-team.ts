export const generateJoinTeamEmail = (name: string, teamName: string, url: string) => {
	return `
	...
	<body>
		...
		>
					...
					>
						<tr>
							<td class="email-masthead">
								<span class="f-fallback email-masthead_name"> COMPESN </span>
							</td>
						</tr>
						<!-- Email Body -->
						<tr>
									...
									<tr>
										<td class="content-cell">
											<div class="f-fallback">
												<h1>Hi ${name},</h1>
												<p>
													You have been added to ${teamName} team. Use the
													button below to confirm and join the team.
												</p>
												<!-- Action -->
												<table
													class="body-action"
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
												...
												<p>Thanks, <br />The COMPESN team</p>
												<!-- Sub copy -->
