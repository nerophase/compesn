	...
	const recentMatches = [
		{
			...
			teamStats: {
				blue: { kills: 23, deaths: 15, assists: 58, dragons: 3, barons: 1, towers: 8 },
				red: { kills: 15, deaths: 23, assists: 41, dragons: 1, barons: 0, towers: 3 },
			},
		},
		{
			...
			teamStats: {
				blue: { kills: 19, deaths: 28, assists: 45, dragons: 2, barons: 0, towers: 4 },
				red: { kills: 28, deaths: 19, assists: 67, dragons: 4, barons: 2, towers: 9 },
			},
		},
		{
			...
			teamStats: {
				blue: { kills: 31, deaths: 12, assists: 78, dragons: 4, barons: 2, towers: 11 },
				red: { kills: 12, deaths: 31, assists: 28, dragons: 0, barons: 0, towers: 1 },
			},
		},
	];
	...
	const liveGame = {
		...
		teams: {
			...
			red: [
				...
				{ summonerName: "Enemy4", championName: "Azir", position: "MID", rank: "Master" },
				{
					summonerName: "Enemy5",
					championName: "Gnar",
					position: "TOP",
							...
							<div className="relative z-10">
								...
								<div className="p-6">
                                  ...
                                  flex items-center justify-center mx-auto mb-3 shadow-lg ring-4 ring-slate-700/50`}
															...
															<div
																className={`text-2xl font-bold ${getRankColor(rank.tier)} mb-1`}
															>
																{rank.tier}
															</div>
														...
														<div className="lg:col-span-2 space-y-4">
															...
															<div className="grid grid-cols-2 gap-3">
																...
																<div className="bg-slate-800/50 border border-slate-700/30 rounded-lg p-3">
																	...
																	<div
																		className={`text-lg font-bold ${rank.winRate >= 50 ? "text-green-400" : "text-red-400"}`}
																	>
											...
											>
												<div className="flex items-center justify-between">
													...
													<div className="text-right">
														<div
															className={`font-bold text-lg flex items-center gap-2 ${match.participant.win ? "text-green-400" : "text-red-400"}`}
														>
															{match.participant.win ? (
																<TrendingUp size={16} />
															) : (
													...
													<div className="p-6 space-y-6">
														...
														<div className="col-span-2 md:col-span-4 bg-slate-800/50 p-4 rounded-lg">
															...
															<div className="grid grid-cols-2 gap-4 text-sm">
																<div
																	className={`p-3 rounded border ${match.participant.team === 100 ? "border-blue-500/50 bg-blue-500/10" : "border-slate-600 bg-slate-700/30"}`}
																>
																...
																<div
																	className={`p-3 rounded border ${match.participant.team === 200 ? "border-red-500/50 bg-red-500/10" : "border-slate-600 bg-slate-700/30"}`}
																>
																	<div className="font-medium mb-2">
																		Red Team
																	</div>
															...
															<div className="mt-3">
																<div className="w-full bg-slate-700 h-2 rounded-full overflow-hidden">
																	<div
																		...
																		style={{
																			width: `${Math.min(100, (achievement.progress.current / achievement.progress.max) * 100)}%`,
																		}}
																	/>
																</div>
																<div className="text-xs text-slate-400 mt-1">
